            ...
            <div className="col-xl-4 col-lg-3 footer-intro mb-15">
              <div className="logo mb-25">
                <Link href="/" className="d-flex align-items-center">
                  <Image src={logo} alt="CNR Handy Services logo" width={40} height={40} priority />
                  <span className="ms-2 fw-bold text-dark fs-4">CNR Handy Services</span>
                </Link>
              </div>
              <a href="#" className="email fw-500">info@cnrhandyservices.com</a>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-4 order-lg-2">
              <p className="text-center mb-15">Copyright @{new Date().getFullYear()} CNR Handy Services.</p>
            </div>
          </div>
        </div>
      </div>
